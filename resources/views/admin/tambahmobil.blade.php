    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                @endif
                <form method="post" action="/tambahmobil" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('plat_mobil') is-invalid @enderror"
                            id="plat_mobil" name="plat_mobil" required value="{{ old('plat_mobil') }}">
                        @error('plat_mobil')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('model') is-invalid @enderror"
                            id="model" name="model" required value="{{ old('model') }}">
                        @error('model')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('price_per_day') is-invalid @enderror"
                            id="price_per_day" name="price_per_day" required value="{{ old('price_per_day') }}">
                        @error('price_per_day')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
