...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-model col-md-3 col-lg-2 me-0 px-3 fs-6 text-white">WhyBali</a>
    </header>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                    ...
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="sidebarMenuLabel">Why Bali</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="offcanvas"
                            data-bs-target="#sidebarMenu" aria-label="Close"></button>
                    </div>
                    {{-- @include('admin.partial.navkiri') --}}
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <form method="post" action="/dashboard/{{ $mobil->plat_mobil }}" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="plat_mobil" name="plat_mobil" required
                            value="{{ old('plat_mobil', $mobil->plat_mobil) }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="status" name="status" required>
                            <option value="available"
                                {{ old('status', $mobil->status) == 'available' ? 'selected' : '' }}>Available</option>
                            <option value="rented" {{ old('status', $mobil->status) == 'rented' ? 'selected' : '' }}>
                                Rented</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="image_url" class="form-label">Gambar</label>
                        <img id="image_preview" class="img-preview img-fluid" style="display: none;">
    ...
    <script>
        ...
        function previewImage() {
            ...
            oFReader.readAsDataURL(image_url.files[0]);
